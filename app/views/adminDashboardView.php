<?php
// Including necessary configuration and database connection files
require_once __DIR__ . '/../../config/constants.php';
require_once __DIR__ . '/../../config/db.php';

// Function to convert status to CSS class for consistent styling
...
<body>
    <div class="dashboard-container">
        ...
        <h1 class="text-4xl font-bold mb-8 text-black text-center">
            <i class="fas fa-chart-line mr-3"></i>Tableau de bord Admin
        </h1>
        ...
        <div class="main-layout">
            ...
            <div class="content-wrapper">
                ...
                <!-- Commandes -->
                <div class="section-content" data-section="commandes">
                ...
                <div class="section-content" data-section="produits">
                    <div class="card">
                        ...
                        <!-- Formulaire d'ajout avec champ catégorie -->
                        ...
                        <!-- Liste des produits avec colonne catégorie -->
                                ...
                                <tbody>
                                    <?php foreach ($produits as $produit): ?>
                                        <tr>
                                            ...
                                            <td><?= htmlspecialchars($produit['categorie'] ?? 'N/A', ENT_QUOTES, 'UTF-8') ?></td>
                                            ...
                                            <td>
                                                ...
                                                <!-- Formulaire de modification avec champ catégorie -->
                                                <form id="form-<?= htmlspecialchars($produit['idProduit'], ENT_QUOTES, 'UTF-8') ?>" method="POST" action="<?= BASE_URL ?>index.php?rout=admin/updateProduit" class="hidden mt-2">
                                                    ...
                                                    <div class="form-grid">
                                                        ...
                                                        <select name="categorie" id="categorie-<?= htmlspecialchars($produit['idProduit'], ENT_QUOTES, 'UTF-8') ?>" class="input-field" required>
                                                            <option value="" disabled>Sélectionner une catégorie</option>
                                                            <option value="Poules" <?= $produit['categorie'] === 'Poules' ? 'selected' : '' ?>>Poules</option>
                                                            <option value="Coqs" <?= $produit['categorie'] === 'Coqs' ? 'selected' : '' ?>>Coqs</option>
                                                            <option value="Œufs" <?= $produit['categorie'] === 'Œufs' ? 'selected' : '' ?>>Œufs</option>
                                                            <option value="Poussins" <?= $produit['categorie'] === 'Poussins' ? 'selected' : '' ?>>Poussins</option>
                                                        </select>
